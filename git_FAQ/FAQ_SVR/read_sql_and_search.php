...
<!--  <label><div><font face="Arial">Welcome to</font></div></label> -->
 ...
 <h1 align="center">問合せ一覧(FAQ)検索</h1></nobr></div> 
 <!-- 検索タイプのデフォルト値設定 -->
 <?php  $search_type = "and_search"; ?>
  <ul style="margin-left:50px">
		...
		<br/>
		<label>※ その他、詳しい使い方は<a href="https://advantec-group.ent.box.com/file/862439460754" target="_blank">こちら</a>を参照ください。</label>
		<label>探したい項目が見つからない場合は、<a href="https://advantec-group.ent.box.com/file/763114430873" target="_blank">システム部担当</a>宛てお問い合わせください。</label><br/>
		<label>※ このサービスに関するご意見・感想は<a href="https://teams.microsoft.com/l/channel/19%3a6c80530927a6448d92df72e8200c10de%40thread.skype/99_FAQ%25E3%2581%2594%25E6%2584%258F%25E8%25A6%258B%25E3%2580%2581%25E3%2581%2594%25E8%25A6%2581%25E6%259C%259B?groupId=f18c3001-63c7-4e7a-aa5b-df8e8ffe8090&tenantId=d5935491-ded4-4e26-b831-3fe9ed3b5445" target="_blank" rel="noopener noreferrer">こちら</a>までお願いします。</label>
		<label>※最終データ更新日：2022年10月3日</label><br/>

<!--	    <label align="center"> ※ DB latest updated: 2021/11/30 </label> -->
</ul>
</form>
